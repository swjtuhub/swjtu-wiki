...
| 需求 | 平台項目 |
| --- | --- |
| 成績與在讀資料 | 成績單列印、學籍（在讀）證明 |
| 課程成績有疑問 | 成績複議申請 |
| 課程衝突或考試處理 | 衝突選課、緩考申請、補考報名 |
| 證件遺失 | 學生證補辦、火車票優惠卡補辦 |
| 學習要求與課表 | 資訊查詢中的培養方案、課程大綱、本學期課程安排、期末考試安排 |
...
[研究生院「下載中心 → 培養工作」](https://gsnews.swjtu.edu.cn/xzzx/pygz.htm)另有管理資訊系統指南及碩博士培養環節資料。部分列表日期較早，但附件或標題另有更新日期，下載時須一併確認。


[選課資訊](/zh-TW/docs/evaluation/course-grades/) · [常用辦事入口](/zh-TW/docs/campus-services/service-directory/)
